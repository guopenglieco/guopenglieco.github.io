...
<div style="background-color: #f8f5fc; border-left: 4px solid #6f42c1; padding: 12px 15px; margin: 15px 0; border-radius: 4px;">
  <strong style="color: #6f42c1;">News:</strong> Our new paper titled "The Value of Influence Data", which investigates how to optimally acquire network information (instead of individual information) to implement personalized pricing, is now available.
</div>
